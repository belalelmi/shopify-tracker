...
// Loads the schema file from src/db/schema
const runSchemaFiles = function () {
  console.log(chalk.magenta(`-> Loading Schema Files ...`));
...
// Loads the seed file from src/db/seeds
const runSeedFiles = function () {
  console.log(chalk.magenta(`-> Loading Seeds ...`));
